...
function renderReporte(est) {
  ...
  // Banner MEI
  html += `<div style="margin:8px;padding:10px 12px;background:rgba(0,212,255,.05);border:1px solid rgba(0,212,255,.15);border-left:3px solid var(--accent);border-radius:5px;">
